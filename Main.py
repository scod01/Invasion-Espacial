...
misil_img_jefe = pygame.transform.scale(pygame.image.load(os.path.join(ASSETS, "misil_jefe.png")), (32, 32))
    ...
    def actualizar(self, balas_enemigas):
        if self.visible:
            ...
            if self.tiempo_disparo >= self.cooldown:
                ...
                balas_enemigas.append({"x": self.x + 64, "y": self.y + 100, "vx": 0, "vy": 3, "origen": "jefe"})
                balas_enemigas.append({"x": self.x + 64, "y": self.y + 100, "vx": -2, "vy": 3, "origen": "jefe"})
                balas_enemigas.append({"x": self.x + 64, "y": self.y + 100, "vx": 2, "vy": 3, "origen": "jefe"})
                self.sonido_disparo.play()
                self.tiempo_disparo = 0
...
misil_img_enemigo = pygame.transform.scale(pygame.image.load(os.path.join(ASSETS, "misil_enemigo.png")).convert_alpha(), (32, 32))
misil_img_jefe = pygame.transform.scale(pygame.image.load(os.path.join(ASSETS, "misil_jefe.png")), (32, 32))
...
while True:
    ...
    while jugando:
        ...
        for ebala in balas_enemigas[:]:
            ...
            # Usa misil del jefe si viene del jefe, sino el normal
            if ebala.get("origen") == "jefe":
                pantalla.blit(misil_img_jefe, (ebala["x"], ebala["y"]))
            else:
